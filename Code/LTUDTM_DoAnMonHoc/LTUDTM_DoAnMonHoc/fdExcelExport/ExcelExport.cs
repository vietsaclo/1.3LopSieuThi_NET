...
namespace LTUDTM_DoAnMonHoc.fdExcelExport
{
    public class ExcelExport
    {
        ...
        public const string T_SanPhams = "SanPhams";
        #endregion
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            if (!Directory.Exists(Application.LocalUserAppDataPath + Constants.FOLDER_TEMPLATES))
            {
                Directory.CreateDirectory(Application.LocalUserAppDataPath + Constants.FOLDER_TEMPLATES);
            }
